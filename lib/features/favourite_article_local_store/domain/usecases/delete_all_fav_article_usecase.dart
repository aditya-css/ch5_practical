...
class DeleteAllFavArticles implements UseCase<ResultState, NoParams> {
  final DataLocalStoreRepository _localStoreRepository;

  DeleteAllFavArticles(this._localStoreRepository);

  @override
  Future<ResultState> call(NoParams params) {
    return _localStoreRepository.deleteAllFavourites();
  }
}
