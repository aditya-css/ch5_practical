...
class DataFetchRepositoryImpl implements DataFetchRepository {
  ...
  @override
  Future<ResultState> getCategories(String src) async {
    try {
      final _jsonResult = await _localJsonService.getLocalCategories(src);
      Categories _cats = CategoriesModel.fromJson(_jsonResult);
      return Success<Categories>(_cats);
    } catch (e) {
