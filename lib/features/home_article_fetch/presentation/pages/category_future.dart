...
import 'package:ch5_practical/core/widgets/shimmer_widgets/category_loading_widget.dart';
...
class _CategoryFuturePageState extends State<CategoryFuturePage> {
  ...
  double get _height => 55;

  @override
  void didChangeDependencies() {
    _categoryFuture = context.watch<DataFetchStore>().getCategories();
